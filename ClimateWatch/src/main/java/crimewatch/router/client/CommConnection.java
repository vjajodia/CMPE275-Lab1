...
import crimewatch.router.server.ServerInitClientSide;
...
public class CommConnection {
	...
	protected  AtomicReference<CommConnection> instance = new AtomicReference<CommConnection>();
	//protected static AtomicReference<CommConnection> instance2 = new AtomicReference<CommConnection>();


	public String host;
	public int port;
	public ChannelFuture channel; // do not use directly call
									// connect()!
	...
	public CommConnection initConnection(String host, int port) {
	...
	public CommConnection getInstance() {
